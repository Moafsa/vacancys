...
const ProfileType_1 = require("../../enums/ProfileType");
describe('UserProfile', () => {
    const mockDate = new Date();
    const mockProfileData = {
        id: '123',
        userId: '456',
        type: ProfileType_1.ProfileType.FREELANCER,
        bio: 'Test bio',
    ...
    describe('constructor', () => {
        it('should create a UserProfile instance with all properties', () => {
            const profile = new UserProfile_1.UserProfile(mockProfileData);
        ...
        it('should create a UserProfile instance with minimal required properties', () => {
            const minimalData = {
                id: '123',
                userId: '456',
                type: ProfileType_1.ProfileType.CLIENT,
                createdAt: mockDate,
                updatedAt: mockDate
            };
            const profile = new UserProfile_1.UserProfile(minimalData);
        ...
        it('should create a UserProfile instance with partial social links', () => {
            ...
            const profile = new UserProfile_1.UserProfile(dataWithPartialSocialLinks);
