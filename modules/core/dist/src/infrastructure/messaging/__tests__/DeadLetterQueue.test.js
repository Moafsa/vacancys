...
describe('DeadLetterQueue', () => {
    ...
    beforeEach(() => {
        dlq = new DeadLetterQueue_1.DeadLetterQueue(maxSize);
    });
    describe('constructor', () => {
        it('should use default maxSize when not provided', () => {
            const defaultDlq = new DeadLetterQueue_1.DeadLetterQueue();
    ...
    describe('addMessage', () => {
        it('should add message successfully', async () => {
            ...
            expect(storedMessage === null || storedMessage === void 0 ? void 0 : storedMessage.message).toEqual(message);
            expect(storedMessage === null || storedMessage === void 0 ? void 0 : storedMessage.error).toBe(error.message);
            expect(storedMessage === null || storedMessage === void 0 ? void 0 : storedMessage.retryCount).toBe(retryCount);
            expect(storedMessage === null || storedMessage === void 0 ? void 0 : storedMessage.originalQueue).toBe(originalQueue);
            expect(storedMessage === null || storedMessage === void 0 ? void 0 : storedMessage.timestamp).toBeInstanceOf(Date);
        });
    ...
    describe('retryMessage', () => {
        ...
        it('should remove and return message for retry', async () => {
            ...
            expect(retryMessage === null || retryMessage === void 0 ? void 0 : retryMessage.message).toEqual(message);
            expect(await dlq.getMessage(messageId)).toBeUndefined();
        });
    });
    describe('clear', () => {
